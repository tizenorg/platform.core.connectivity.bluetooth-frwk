...
#include "uts_bluetooth_set_discoverable_mode.h"
...
void utc_bluetooth_set_discoverable_mode_1(void)
{
	bluetooth_discoverable_mode_t discoverable_mode;
	int return_8;
	int ret_val;
	...
	/* 60 seconds */
	return_8 = bluetooth_set_discoverable_mode(discoverable_mode, 60);
...
void utc_bluetooth_set_discoverable_mode_2(void)
{
	bluetooth_discoverable_mode_t discoverable_mode;
	int return_8;
	int ret_val;
	...
	discoverable_mode=-1;
	return_8=bluetooth_set_discoverable_mode(discoverable_mode, 0);
	if(	return_8>=0)
	{
	tet_printf("Api failed");
	tet_result(TET_FAIL);
