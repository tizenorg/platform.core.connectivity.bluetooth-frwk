...
#include "uts_bluetooth_get_local_name.h"
...
void utc_bluetooth_get_local_name_1(void)
{
	bluetooth_device_name_t local_name={{"local Name"}};
	...
	return_5=bluetooth_set_local_name(&local_name);

	return_5=bluetooth_get_local_name(&local_name);
	if(	return_5<0)
	{
...
void utc_bluetooth_get_local_name_2(void)
{
	...
	return_5=bluetooth_get_local_name(NULL);
	if(	return_5>=0)
	{
	tet_printf("Api failed");
	tet_result(TET_FAIL);
