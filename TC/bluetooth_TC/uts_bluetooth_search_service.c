...
#include "uts_bluetooth_search_service.h"
...
void utc_bluetooth_search_service_1(void)
{
	...
	return_18=bluetooth_search_service(&device_address);
	if(	return_18<0)
	{
...
void utc_bluetooth_search_service_2(void)
{
...
//	device_address=NULL;
	return_18=bluetooth_search_service(NULL);
	if(	return_18>=0)
	{
