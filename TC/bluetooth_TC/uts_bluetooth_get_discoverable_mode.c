...
#include "uts_bluetooth_get_discoverable_mode.h"
...
void utc_bluetooth_get_discoverable_mode_1(void)
{
	...
	return_7=bluetooth_set_discoverable_mode(mode, 60); // 60 seconds

	return_7=bluetooth_get_discoverable_mode(&discoverable_mode_ptr);
	if(	return_7<0)
	{
...
void utc_bluetooth_get_discoverable_mode_2(void)
{
	bluetooth_discoverable_mode_t* discoverable_mode_ptr;
	int 	return_7;
		int ret_val;
