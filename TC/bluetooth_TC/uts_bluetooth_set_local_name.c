...
#include "uts_bluetooth_set_local_name.h"
...
void utc_bluetooth_set_local_name_1(void)
{
	...
	return_6=bluetooth_set_local_name(&local_name);
	if(	return_6<0)
	{
...
void utc_bluetooth_set_local_name_2(void)
{
