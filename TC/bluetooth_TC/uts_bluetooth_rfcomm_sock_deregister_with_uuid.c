...
#include "uts_bluetooth_rfcomm_sock_deregister_with_uuid.h"
...
void utc_bluetooth_rfcomm_sock_deregister_with_uuid_1(void)
{
	char uuid[]="id";
	int return_21;
	int ret_val;
	...
	return_21=bluetooth_rfcomm_sock_register_with_uuid(&uuid);

	return_21=bluetooth_rfcomm_sock_deregister_with_uuid(uuid);
	if(	return_21<0)
	{
...
void utc_bluetooth_rfcomm_sock_deregister_with_uuid_2(void)
{
	char* uuid;
	int return_21;
	int ret_val;
