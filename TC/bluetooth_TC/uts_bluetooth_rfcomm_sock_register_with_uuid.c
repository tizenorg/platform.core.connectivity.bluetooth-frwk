...
#include "uts_bluetooth_rfcomm_sock_register_with_uuid.h"
...
void utc_bluetooth_rfcomm_sock_register_with_uuid_1(void)
{
	char uuid[]="00000000-0000-1000-8000-00805F9B34FB";//"id";
	int return_20;
	int ret_val;
	...
	//uuid =NULL;//assign value over here
	return_20=bluetooth_rfcomm_sock_register_with_uuid(&uuid);
	if(	return_20<0)
	{
...
void utc_bluetooth_rfcomm_sock_register_with_uuid_2(void)
{
	char* uuid;
	int return_20;
	int ret_val;
